...
INSERT INTO coaches (id, name, last_name, nationality, age, club_id) VALUES (DEFAULT, 'Henry', 'Doe', 'English', 27, 2);
...
INSERT INTO club_competitions (club, competition) VALUES ((SELECT id FROM clubs WHERE name = 'Barcelona'), (SELECT id FROM football_competiotions WHERE name = 'La Liga'));

INSERT INTO players (id, name, last_name, nationality, age, position, club_id) VALUES (DEFAULT, 'Lionel', 'Messi', 'Argentinian', 36, 'Forward', (SELECT id FROM clubs WHERE name = 'Real Madrid'));
INSERT INTO players (id, name, last_name, nationality, age, position, club_id) VALUES (DEFAULT, 'Robert', 'Lewandowski', 'Polish', 35, 'Forward', (SELECT id FROM clubs WHERE name = 'Barcelona'));
INSERT INTO players (id, name, last_name, nationality, age, position, club_id) VALUES (DEFAULT, 'Bruno', 'Fernandes', 'Portuguese', 29, 'Midfielder', (SELECT id FROM clubs WHERE name = 'Barcelona'));
